                        ...
                        <ul class="divide-y divide-gray-200 w-full">
                            ...
                            <li class="p-3 flex items-center">
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm font-medium text-gray-600">Tiempo de Postulación: <span class="font-normal">{{ $candidato->created_at->diffForHumans() }}</span></p>

                                </div>

                                <div>
                                    <a class="
                                    inline-flex items-center shadow-sm px-2.5 border border-gray-300 text-sm leading-5
                                    font-medium rounded-full text-indigo-700 bg-white hover:bg-gray-50" target="_blank"
